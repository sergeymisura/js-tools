...
null},compile:function(a){d.each(this._.transformations,function(b,c){var f=a.find(c.selector);a.is(c.selector)&&f.andSelf();f.each(function(b,a){var f=c.fn(d(a),app.services);"undefined"!=typeof f&&null!==f&&d(a).replaceWith(f)})});return a},log:function(a){"undefined"!=typeof console&&"undefined"!=typeof console.log&&console.log(a)},createServices:function(a){var b={};d.each(app._.serviceFactories,function(c,d){b[c]=app.wrapObject(d(a,b))});return b},createController:function(a){var b=d(a),c=app._.controllerFactories[b.attr("data-controller")];
if("undefined"!=typeof c)return a.controller=app.wrapObject(c(b,this.createServices(b))),"function"==typeof a.controller.init&&a.controller.init(),a.controller}});app.config.legacy&&d.extend(app,{ready:function(a,b){this.log('app.ready() function is deprecated. Use application\'s "ready" event instead.');d(app).on("ready",d.proxy(a,b))}});d.fn.outerHtml=function(){return d("<div/>").append(this).html()}})(jQuery);(function(d,a){a.wrapObject(a);d(document).ready(function(){var b=d("body");a.services=a.createServices(b);a.transformation("[data-controller]",function(b){a.createController(b.get(0))});a.compile(b);d(a).triggerHandler("ready")});if(a.config.legacy)d(document).on("mouseup.auto-close",function(b){d('[data-close="auto"]:visible').each(function(a,f){var e=d(f);0!==e.has(b.target).length||e.is(b.target)||e.hide()})});Object.keys||(Object.keys=function(b){var a=[],d;for(d in b)b.hasOwnProperty(d)&&a.push(d);
return a})})(jQuery,app);(function(){var d=function(a){return function(b,c,d){c=null;if("application/json"==b.getResponseHeader("Content-Type"))try{c=$.parseJSON(b.responseText)}catch(e){c=null}$(app).trigger("api.error",[b.status,c,b]);a.triggerError(b.status,c,b)||$(app).trigger("api.error.unhandled",[b.status,c,b])}};app.service("api",function(a,b){return{get:function(a,f){"undefined"==typeof f&&(f={});var e=b.deferred();$.ajax(app.config.apiUrl+"/"+a,{data:f,success:e.successCallback(),error:d(e)});return e},post:function(a,
f){"undefined"==typeof f&&(f={});var e=b.deferred();$.ajax(app.config.apiUrl+"/"+a,{type:"post",contentType:"application/json",dataType:"json",data:JSON.stringify(f),success:e.successCallback(),error:d(e)});return e}}})})(jQuery,app);(function(){app.service("events",function(d,a){return function(){d.get(0);var b,c;2>arguments.length?(c=arguments[0],b=d):(b=$(arguments[0]),c=arguments[1],c[""]={},$.each(c,function(b,a){if("function"==typeof a||"string"==typeof a)c[""][b]=a,delete c[b]}));$.each(c,function(c,e){if("string"==typeof e||"function"==typeof e)e={click:e};$.each(e,function(e,g){b.on(e,c,function(b){var c=$(this),e;e="string"==typeof g?d[0].controller[g]:g;var f=[].slice.call(arguments),c=$(this);f.unshift(c);b.data=a.rendering.container(c).data("data");
...
$.extend(c,d)).data("data",b).data("filters",c).data("template",a).addClass("rendered").removeAttr("data-template")},c=function(a,b,d){return c.render(a,b,d)};$.extend(c,{render:function(c,d,k){k=k||{};var g=a[0].templates[c];if(g){var h=$();d.constructor===Array?$.each(d,function(a,c){h=h.add(b(g,c,k))}):h=h.add(b(g,d,k));0==h.length&&(h=$("<script />").attr("type","text/html"));h=app.compile(h);g.placeholder.replaceWith(h);return g.placeholder=h}},refresh:function(a,c){a=this.container(a);"undefined"==
typeof c&&(c=a.data("data"));var d=a.data("template"),g=a.data("filters"),d=b(d,c,g);a.replaceWith(d);return app.compile(d)},container:function(a){return a.closest(".rendered")}});return c})})(jQuery,app);(function(d,a){a.transformation("[data-template]",function(b){if(0!=b.parents("body").length){b.find("[data-template]").each(function(a,b){templateTransformation(d(b))});var c=b.closest("[data-controller]").get(0);if(c){var f=b.attr("data-template"),e=d("<script />").attr("type","text/html");"undefined"==typeof c.templates&&(c.templates={});b.replaceWith(e);b="SCRIPT"==b.prop("tagName")?b.html():b.outerHtml();c.templates[f]={fn:a.templateWrapper()(b),placeholder:e}}}});a.transformation("img[data-src],audio[data-src],video[data-src]",
function(a){0<a.parents(".rendered").length&&a.attr("src",a.data("src"))})})(jQuery,app);(function(d,a){var b=0;a.templateWrapper("jQuery.tmpl",function(a){var f="jstools-jquery-tmpl-"+b++;d.template(f,a);return function(a,b){var c=d.tmpl(f,d.extend(a,b));d.each(a,function(b,c){0==b.indexOf("$")&&delete a[b]});return c}})})(jQuery,app);(function(d,a){a.templateWrapper("Mustache",function(a){Mustache.parse(a);return function(c,f){var e={};d.each(f,function(a,b){e[a]=function(){return function(a,c){return b(c(a))}}});var k=d(Mustache.render(a,d.extend(c,e)));d.each(c,function(a,b){0==a.indexOf("$")&&delete c[a]});return k}})})(jQuery,app);(function(d,a){a.templateWrapper("Underscore.js",function(a){var c=_.template(a);return function(a,b){var k=d(c(d.extend(a,b)));d.each(a,function(b,c){0==b.indexOf("$")&&delete a[b]});return k}})})(jQuery,app);
