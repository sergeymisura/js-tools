/*!
 * js-tools library
 * Version 1.1.8 built 01/29/2015
 *
...
app.config.apiUrl+"/"+a,{type:"post",contentType:"application/json",dataType:"json",data:JSON.stringify(e),success:f.successCallback(),error:d(f)});return f}}})})(jQuery,app);(function(d,a){a.service("hash",function(b,a){var e=function(a){var c=function(){var c=document.location.hash;0==c.indexOf("#")&&(c=c.substr(1));var d="";-1!=c.indexOf("?")&&(d=c.substr(c.indexOf("?")+1),c=c.substr(0,c.indexOf("?")));for(var e=d.split("&"),p={},l=0;l<e.length;l++){var m=e[l].split("=");p[decodeURIComponent(m[0])]=decodeURIComponent(1<m.length?m[1]:"")}e=c.split("/");l=null;"undefined"!==typeof a[e[0]]?l=a[e[0]]:"undefined"!==typeof a[""]&&(l=a[""]);null!=l&&(l="string"==typeof l?
b[0].controller[l]:l,e.splice(0,0,{hash:c,queryString:d,query:p}),l.apply(b[0].controller,e))};d(window).on("hashchange",c);c()};d.extend(e,{bind:e,go:function(){document.location="#"+d.makeArray(arguments).join("/")}});return e})})(jQuery,app);(function(){app.service("events",function(d,a){return function(){d.get(0);var b,c;2>arguments.length?(c=arguments[0],b=d):(b=$(arguments[0]),c=arguments[1],c[""]={},$.each(c,function(a,b){if("function"==typeof b||"string"==typeof b)c[""][a]=b,delete c[a]}));$.each(c,function(c,f){if("string"==typeof f||"function"==typeof f)f={click:f};$.each(f,function(f,g){b.on(f,c,function(b){var c=$(this),e;e="string"==typeof g?d[0].controller[g]:g;var f=[].slice.call(arguments),c=$(this);f.unshift(c);b.data=a.rendering.container(c).data("data");
